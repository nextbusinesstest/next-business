export const VARIANTS = {
  ...
  // --- HERO (añadir dentro de VARIANTS.hero) ---
...
// --- SECTIONS (añadir dentro de VARIANTS.sections) ---
categories_scroller_min_v1: { personalities: ["modern_minimal"], density: ["light"], risk: ["safe"] },
benefits_cards_min_v1: { personalities: ["modern_minimal"], density: ["light", "medium"], risk: ["safe"] },
contact_center_min_v1: { personalities: ["modern_minimal"], density: ["light", "medium"], risk: ["safe"] },
