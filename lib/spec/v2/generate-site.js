...
function buildCopyV1({
  ...
  // ✅ FIX mínimo: evitar “Solicita Solicitar demo…”
  function formatSingleActionNote(detail) {
    ...
    const startsWithVerb =
      /^(solicita|pide|reserva|contacta|obt(e|é)n|descarga|agenda)\b/i.test(d);

    return startsWithVerb ? `${d} y te respondemos en breve.` : `Solicita ${d} y te respondemos en breve.`;
  }
